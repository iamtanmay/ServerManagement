...
(function () {
    ...
    function injectMyCustomFooter() {
        ...
        footerDiv.style.cssText = "display: flex; flex-direction: column; align-items: flex-start; margin: 120px 0; padding: 10px; width: 100%; position: relative; z-index: 9999; clear: both;";
