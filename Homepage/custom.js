 ...
 */
    ...
    (function () {
        ...
        function injectMyCustomFooter() {
            ...
            footerDiv.style.cssText = "display: flex; flex-direction: column; align-items: flex-start; margin: 0px 0; padding: 20px 20px 20px 6rem; position: relative; z-index: 9999; clear: both;";
